...
part_chapter_dict_wakati = pickle.load(open("part_chapter_dict_wakati_org.pickle", "rb"))
part_chapter_dict_wakati.pop('1-1')
part_chapter_dict_wakati.pop('1-2')
part_chapter_dict_wakati.pop('1-3')
part_chapter_dict_wakati.pop('3-1')
part_chapter_dict_wakati.pop('3-2')
part_chapter_dict_wakati.pop('3-3')
part_chapter_dict_wakati.pop('3-4')
part_chapter_dict_wakati.pop('3-5')
part_chapter_dict_wakati.pop('3-6')
part_chapter_dict_wakati.pop('3-7')
part_chapter_dict_wakati.pop('3-8')
part_chapter_dict_wakati.pop('3-9')
...
h_flat1_0 = tf.reshape(h_conv1_0, [-1, h_conv1_0.shape[1] * 10 * 128])
W_fc1 = weight_variable([h_conv1_0.get_shape().as_list()[1] * 10 * 128, 128])
...
h_flat1_1 = tf.reshape(h_conv1_1, [-1, h_conv1_0.shape[1] * 10 * 128])
...
h_flat1_2 = tf.reshape(h_conv1_2, [-1, h_conv1_0.shape[1] * 10 * 128])
...
h_flat1_3 = tf.reshape(h_conv1_3, [-1, h_conv1_0.shape[1] * 10 * 128])
...
h_flat1_4 = tf.reshape(h_conv1_4, [-1, h_conv1_0.shape[1] * 10 * 128])
...
h_flat1_5 = tf.reshape(h_conv1_5, [-1, h_conv1_0.shape[1] * 10 * 128])
...
h_flat1_6 = tf.reshape(h_conv1_6, [-1, h_conv1_0.shape[1] * 10 * 128])
...
h_flat1_7 = tf.reshape(h_conv1_7, [-1, h_conv1_0.shape[1] * 10 * 128])
...
h_flat1_8 = tf.reshape(h_conv1_8, [-1, h_conv1_0.shape[1] * 10 * 128])
...
h_flat1_9 = tf.reshape(h_conv1_9, [-1, h_conv1_0.shape[1] * 10 * 128])
...
h_flat1_10 = tf.reshape(h_conv1_10, [-1, h_conv1_0.shape[1] * 10 * 128])
...
h_flat1_11 = tf.reshape(h_conv1_11, [-1, h_conv1_0.shape[1] * 10 * 128])
...
h_flat1_12 = tf.reshape(h_conv1_12, [-1, h_conv1_0.shape[1] * 10 * 128])
...
h_flat1_13 = tf.reshape(h_conv1_13, [-1, h_conv1_0.shape[1] * 10 * 128])
...
h_flat1_14 = tf.reshape(h_conv1_14, [-1, h_conv1_0.shape[1] * 10 * 128])
...
h_flat1_15 = tf.reshape(h_conv1_15, [-1, h_conv1_0.shape[1] * 10 * 128])
...
h_flat1_16 = tf.reshape(h_conv1_16, [-1, h_conv1_0.shape[1] * 10 * 128])
...
h_flat1_z = tf.reshape(h_conv1_z, [-1, h_conv1_0.shape[1] * 10 * 128])
...
# 全結合層2
W_fc3 = weight_variable([128, length_part_chapter_dict_wakati])
b_fc3 = bias_variable([length_part_chapter_dict_wakati])
