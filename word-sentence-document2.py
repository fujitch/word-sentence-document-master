...
W_fc1 = weight_variable([9 * 10 * 64, 128])
...
h_flat1_0 = tf.reshape(h_conv1_0, [-1, 9 * 10 * 64])
...
h_flat1_1 = tf.reshape(h_conv1_1, [-1, 9 * 10 * 64])
...
h_flat1_2 = tf.reshape(h_conv1_2, [-1, 9 * 10 * 64])
...
h_flat1_3 = tf.reshape(h_conv1_3, [-1, 9 * 10 * 64])
...
h_flat1_4 = tf.reshape(h_conv1_4, [-1, 9 * 10 * 64])
...
h_flat1_5 = tf.reshape(h_conv1_5, [-1, 9 * 10 * 64])
...
h_flat1_6 = tf.reshape(h_conv1_6, [-1, 9 * 10 * 64])
...
h_flat1_7 = tf.reshape(h_conv1_7, [-1, 9 * 10 * 64])
...
h_flat1_8 = tf.reshape(h_conv1_8, [-1, 9 * 10 * 64])
...
h_flat1_9 = tf.reshape(h_conv1_9, [-1, 9 * 10 * 64])
...
h_flat1_10 = tf.reshape(h_conv1_10, [-1, 9 * 10 * 64])
...
h_flat1_11 = tf.reshape(h_conv1_11, [-1, 9 * 10 * 64])
...
h_flat1_12 = tf.reshape(h_conv1_12, [-1, 9 * 10 * 64])
...
h_flat1_13 = tf.reshape(h_conv1_13, [-1, 9 * 10 * 64])
...
h_flat1_14 = tf.reshape(h_conv1_14, [-1, 9 * 10 * 64])
...
h_flat1_15 = tf.reshape(h_conv1_15, [-1, 9 * 10 * 64])
...
h_flat1_16 = tf.reshape(h_conv1_16, [-1, 9 * 10 * 64])
...
h_flat1_z = tf.reshape(h_conv1_z, [-1, 9 * 10 * 64])
...
h_flat2 = tf.reshape(h_conv2, [-1, 1 * 15 * 64])

# 全結合層1
W_fc2 = weight_variable([64 * 15, 128])
...
h_flat2_0 = tf.reshape(h_conv2_0, [-1, 1 * 15 * 64])
...
h_flat2_1 = tf.reshape(h_conv2_1, [-1, 1 * 15 * 64])
...
h_flat2_2 = tf.reshape(h_conv2_2, [-1, 1 * 15 * 64])
...
h_flat2_3 = tf.reshape(h_conv2_3, [-1, 1 * 15 * 64])
...
h_flat2_4 = tf.reshape(h_conv2_4, [-1, 1 * 15 * 64])
...
h_flat2_5 = tf.reshape(h_conv2_5, [-1, 1 * 15 * 64])
...
h_flat2_6 = tf.reshape(h_conv2_6, [-1, 1 * 15 * 64])
...
h_flat2_7 = tf.reshape(h_conv2_7, [-1, 1 * 15 * 64])
...
h_flat2_8 = tf.reshape(h_conv2_8, [-1, 1 * 15 * 64])
...
h_flat2_9 = tf.reshape(h_conv2_9, [-1, 1 * 15 * 64])
...
h_flat2_10 = tf.reshape(h_conv2_10, [-1, 1 * 15 * 64])
...
h_flat2_11 = tf.reshape(h_conv2_11, [-1, 1 * 15 * 64])
...
h_flat2_12 = tf.reshape(h_conv2_12, [-1, 1 * 15 * 64])
...
h_flat2_13 = tf.reshape(h_conv2_13, [-1, 1 * 15 * 64])
...
h_flat2_14 = tf.reshape(h_conv2_14, [-1, 1 * 15 * 64])
...
h_flat2_15 = tf.reshape(h_conv2_15, [-1, 1 * 15 * 64])
...
h_flat2_16 = tf.reshape(h_conv2_16, [-1, 1 * 15 * 64])
